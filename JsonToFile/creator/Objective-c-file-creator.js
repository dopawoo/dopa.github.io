...
* 获取文件信息
*/
WPFileInfoMetaHandler.prototype.getFileInfoArrayForObjectiveC = function() {
	var className = this.modelInfoMeta.className;

	//.h文件
	var hFile = new WPFileInfoMeta(this.modelInfoMeta);
	...
	//.m文件
	var mFile = new WPFileInfoMeta(this.modelInfoMeta);
...
* 更新import信息
*/
WPFileInfoMetaHandler.prototype.updateImportTextForObjectiveC = function(fileMeta) {
...
* 更新className
*/
WPFileInfoMetaHandler.prototype.updateClassNameForObjectiveC = function() {
...
*/
WPFileInfoMetaHandler.prototype.fileMetaUpdateClassNameForObjectiveC = function(fileMeta) {
...
*/
WPFileInfoMetaHandler.prototype.updateParentPropertyTypeForObjectiveC = function(fileMeta) {
...
* 更新属性类型
*/
WPFileInfoMetaHandler.prototype.fileUpdatePropertyTypeForObjectiveC = function() {
	for (var i in this.filesArray) {
		var fileMeta = this.filesArray[i];
		if (fileMeta.extensionName == "h") {
			//更新导入文件
...
* 文件创建注释信息
*/
WPFileInfoMetaHandler.prototype.getCreatedInfoTextForObjectiveC = function(extensionName) {
	var className = this.modelInfoMeta.className;
	var date = new Date();
...
WPFileInfoMeta.prototype.getDetailInfoForObjectiveC = function() {
...
WPCreateFileContentForAllClassForObjectiveC = function(array) {
